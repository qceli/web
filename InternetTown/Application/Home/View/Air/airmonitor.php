...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/css/airmonitor.css">
</head>
<body>
    <div class="bg-img">
        ...
        <div class="bottom">
            <div class="bottom-title">
                ...
                <span class="title-num">{$data['YL']}</span>
            </div>
            <div class="bottom-line">
                <div class="weather-list">
                    <div class="list1">PM2.5</div>
                    <div class="list2">{$data['KLW25']}</div>
                </div>
                <div class="weather-list">
                    <div class="list1">CO</div>
                    <div class="list2">{$data['YYHT']}</div>
                </div>
                <div class="weather-list">
                    <div class="list1">O3</div>
                    <div class="list2">{$data['CY']}</div>
                </div>
            </div>
            <div class="bottom-line">
                <div class="weather-list">
                    <div class="list1">PM10</div>
                    <div class="list2">{$data['KLW10']}</div>
                </div>
                <div class="weather-list">
                    <div class="list1">SO2</div>
                    <div class="list2">{$data['EYHL']}</div>
                </div>
                <div class="weather-list">
                    <div class="list1">NO2</div>
                    <div class="list2">{$data['EYHD']}</div>
                </div>
            </div>
        </div>
    </div>
