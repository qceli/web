...
<div style="width: 104%; height: 100%; overflow: scroll; position: relative;-webkit-overflow-scrolling: touch;">
    ...
    <img class="img-wrap" src="__PUBLIC__/images/microprogram/map-1.jpg" />

    <img class="position" id="position1" src="__PUBLIC__/images/microprogram/position.png" />
    <img class="position" id="position2" src="__PUBLIC__/images/microprogram/position.png" />
    <img class="position" id="position3" src="__PUBLIC__/images/microprogram/position.png" />
    <img class="position" id="position4" src="__PUBLIC__/images/microprogram/position.png" />
    <img class="position" id="position6" src="__PUBLIC__/images/microprogram/position.png" />
    <img class="position" id="position7" src="__PUBLIC__/images/microprogram/position.png" />
