...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            <foreach name="micro_arts" item="m_art">
                CustomersData.Rows.push({
                    "id":"{$m_art.id}",
                    "title":"{$m_art.title}",
                    "category":"{$m_art.category}",
                    "author":"{$m_art.author}",
                    "created_time":"{$m_art.created_time|date='Y-m-d H:i:s', ###}",
                    "content":{$m_art.content}
                });
            </foreach>
        ...
        function itemclick(item) {
            ...
            if (item.icon === 'delete') {
                ...
                $.ligerDialog.confirm('确定删除此行？', function (yes) {
                    if (yes) {
                        $.post("{:U('MicroArticle/del')}", {id: row.id}, function (res) {
                            if (!res.status) {
