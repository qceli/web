...
<div id="editticket">
    <table>
        <tbody>
        <input type="hidden" id="tid" name="id" value="<?php echo ($ticket["id"]); ?>"/>
        <tr>
            <td>
            ...
            <td>
                <div class="l-text" style="width: 200px;">
                    <input id="billcode" name="billcode" type="text" class="ui-textbox l-text-field"
                           ligeruiid="textbox1" value="<?php echo ($ticket["billcode"]); ?>"/>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="l-text" style="width: 200px;">
                    <input id="ticket_name" name="ticket_name" type="text" class="ui-textbox l-text-field"
                           ligeruiid="textbox1" value="<?php echo ($ticket["ticket_name"]); ?>"/>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <input type="hidden" id="ticket_pic" name="ticket_pic" value="<?php echo ($ticket["ticket_pic"]); ?>"/>
            ...
            <td>
                <div class="l-text" style="width: 200px;">
                    <input id="ticket_price" name="ticket_price" type="text" class="ui-textbox l-text-field"
                           ligeruiid="textbox1" value="<?php echo ($ticket["ticket_price"]); ?>"/>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <textarea id="warning" name="warning" class="ui-textarea" rows="10" cols="20"
                          style="width:400px;"><?php echo ($ticket["warning"]); ?></textarea>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <textarea id="sight_info" name="sight_info" class="ui-textarea" rows="10" cols="20"
                          style="width:400px;"><?php echo ($ticket["sight_info"]); ?></textarea>
            </td>
        </tr>
        </tbody>
    </table>
