                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <input id="verifyCode" class="form-control" placeholder="验证码" name="verifyCode"
                                       type="text">
                                <img src="<?php echo U('Login/verifyCodeServlet');?>"
                                     onclick="javascript:this.src='<?php echo U('Login/verifyCodeServlet');?>?id='+  Math.random();"
                                     alt="看不清,换一个,请点我"/>
                            </div>
                            <div class="checkbox">
                                <label>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#button").on('click', function () {
            $.post("<?php echo U('Login/loginValidate');?>",
                {
