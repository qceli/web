        ...
        <tr>
            ...
            <td>
                <div class="l-text" style="width: 250px;">
                    <input type="hidden" name="id" id="c_id" value="<?php echo ($art["id"]); ?>"/>
                    <input id="title" name="title" type="text" width="250px" class="ui-textbox l-text-field"
                           ligeruiid="textbox1" value="<?php echo ($art["title"]); ?>"/>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <select id="category" name="category" class="ui-textbox l-text" style="width: 220px;">
                    <?php if(is_array($categorys)): foreach($categorys as $key=>$category): if($category["id"] == $art['category']): ?><option value="<?php echo ($category["id"]); ?>" selected><?php echo ($category["name"]); ?></option>
                            <?php else: ?>
        ...
        <tr>
            ...
            <td>
                <textarea id="content" name="content" class="ui-textarea" rows="10" cols="20"
                          style="width:600px;height: 380px;"><?php echo (htmlspecialchars_decode($art["content"])); ?></textarea>
            </td>
        </tr>
        </tbody>
    </table>
